...
export const DEFAULT_LANDING_CLIENT_LOGOS = [
  { order: 1, name: 'Amazon', image: Amazon },
  { order: 2, name: 'Ather', image: Ather },
  { order: 3, name: 'Fairfield by Marriott', image: FairfieldMarriott },
  { order: 4, name: 'Flipkart', image: Flipkart },
  { order: 5, name: 'Four Points', image: FourPoints },
  { order: 6, name: 'Grant Thornton', image: GrantThornton },
  { order: 7, name: 'Hexaware', image: Hexaware },
  { order: 8, name: 'J.P. Morgan', image: JPMorgan },
  { order: 9, name: 'Lemon Tree Hotels', image: LemonTree },
  { order: 10, name: 'London Stock Exchange', image: LondonStockExchange },
  { order: 11, name: 'MindSprint', image: Mindsprint },
  { order: 12, name: 'Nestlé', image: Nestle },
  { order: 13, name: 'PwC', image: PwC },
  { order: 14, name: 'Raintree Hotels', image: RaintreeHotels },
  { order: 15, name: 'Samsung', image: Samsung },
  { order: 16, name: 'Sopra Steria', image: SopraSteria },
  { order: 17, name: 'Taj Hotels', image: TajHotels },
  { order: 18, name: 'TCS', image: TCS },
