...
class Unicamp {
	...
	public static function menu_mobile_primary() {
		...
		if ( UNICAMP_IS_RTL ) {
			$mobile_menu = preg_replace( $pattern, '<ul id="mobile-menu-primary" class="menu__container mobile-menu-primary-rtl">', $unicamp_primary_menu );
		} else {
			$mobile_menu = preg_replace( $pattern, '<ul id="mobile-menu-primary" class="menu__container">', $unicamp_primary_menu );
		}
