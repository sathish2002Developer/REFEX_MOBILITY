...
<form class="woocommerce-EditAccountForm edit-account" action=""
	...
	<div class="row form-row ">
		<div class="col-md-6">
			<label for="account_first_name"><?php esc_html_e( 'First name', 'unicamp' ); ?>&nbsp;<span class="required"
		...
		<div class="col-md-6">
			<label for="account_last_name"><?php esc_html_e( 'Last name', 'unicamp' ); ?>&nbsp;<span class="required"
			                                                                                         aria-hidden="true">*</span></label>
	...
	<div class="row form-row">
		<div class="col-md-6">
			...
			<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_display_name"
				...
				id="account_display_name_description"><em><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'unicamp' ); ?></em></span>
		</div>
		<div class="col-md-6">
			<label for="account_email"><?php esc_html_e( 'Email address', 'unicamp' ); ?>&nbsp;<span class="required"
			                                                                                         aria-hidden="true">*</span></label>
