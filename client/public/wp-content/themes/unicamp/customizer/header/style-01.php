...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.header-01 .header-wrap .menu--secondary > ul > li > a',
		),
	),
) );
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'   => array(
		array(
			'element' => '.header-01.header-dark .header-bottom',
		),
	),
) );
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		...
		array(
			'choice'   => 'normal',
			'element'  => '.page-header.header-01.headroom--not-top .menu--primary > ul > li > a',
			'property' => 'color',
			'suffix'   => '!important',
		),
		array(
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.header-01.header-dark  .header-wrap .menu--secondary > ul > li > a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'          => Unicamp_Header::instance()->get_button_kirki_output( '01', 'dark', false ),
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'          => Unicamp_Header::instance()->get_button_kirki_output( '01', 'dark', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'dark_button_color',
			'operator' => '==',
...
Unicamp_Kirki::add_field( 'theme', array(
	'type'        => 'multicolor',
	'settings'    => $prefix . 'light_secondary_navigation_link_color',
	'label'       => esc_html__( 'Link Color', 'unicamp' ),
	'description' => esc_html__( 'Controls the color for main menu items.', 'unicamp' ),
	'section'     => $section,
	'priority'    => $priority++,
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.header-01.header-light  .header-wrap .menu--secondary > ul > li > a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'          => Unicamp_Header::instance()->get_button_kirki_output( '01', 'light', false ),
	'active_callback' => array(
		array(
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'          => Unicamp_Header::instance()->get_button_kirki_output( '01', 'light', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'light_button_color',
			'operator' => '==',
