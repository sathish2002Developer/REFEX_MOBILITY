...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.header-06 .header-wrap .menu--secondary > ul > li > a',
		),
	),
) );
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.header-06.header-dark  .header-wrap .menu--secondary > ul > li > a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'          => Unicamp_Header::instance()->get_button_kirki_output( '06', 'dark', false ),
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'          => Unicamp_Header::instance()->get_button_kirki_output( '06', 'dark', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'dark_button_color',
			'operator' => '==',
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.header-06.header-light  .header-wrap .menu--secondary > ul > li > a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'          => Unicamp_Header::instance()->get_button_kirki_output( '06', 'light', false ),
	'active_callback' => array(
		array(
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'          => Unicamp_Header::instance()->get_button_kirki_output( '06', 'light', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'light_button_color',
			'operator' => '==',
