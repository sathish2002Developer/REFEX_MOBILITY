...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'          => Unicamp_Header::instance()->get_search_form_kirki_output( '02', 'dark', false ),
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'          => Unicamp_Header::instance()->get_search_form_kirki_output( '02', 'dark', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'          => Unicamp_Header::instance()->get_button_kirki_output( '02', 'dark', false ),
	'active_callback' => array(
		array(
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'          => Unicamp_Header::instance()->get_button_kirki_output( '02', 'dark', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'dark_button_color',
			'operator' => '==',
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'          => Unicamp_Header::instance()->get_button_kirki_output( '02', 'light', false ),
	'active_callback' => array(
		array(
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'output'          => Unicamp_Header::instance()->get_button_kirki_output( '02', 'light', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'light_button_color',
			'operator' => '==',
