...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'description' => esc_html__( 'Select header style that displays on faq archive pages.', 'unicamp' ),
	'section'     => $section,
	'priority'    => $priority++,
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'description' => esc_html__( 'Select sidebar 1 that will display on faq archive pages.', 'unicamp' ),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 'faq_sidebar',
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'description' => esc_html__( 'Select sidebar 2 that will display on faq archive pages.', 'unicamp' ),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 'none',
	'choices'     => $registered_sidebars,
...
Unicamp_Kirki::add_field( 'theme', array(
	...
	'description' => esc_html__( 'Controls the number of faqs display on faq archive page', 'unicamp' ),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => 6,
	'choices'     => array(
