...
class Widget_Modern_Carousel extends Carousel_Base {
	...
	public function get_title() {
		return esc_html__( 'Modern Carousel', 'unicamp' );
	}
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'unicamp-modern-carousel' );
		?>
	...
	private function add_content_section() {
		...
		$this->add_control( 'style', [
			...
			'default'      => '01',
			'prefix_class' => 'unicamp-modern-carousel-style-',
		...
		$repeater->add_control( 'tags', [
			...
			'type'        => Controls_Manager::TEXTAREA,
			'placeholder' => esc_html__( 'One tag per line', 'unicamp' ),
		] );
	...
	private function add_style_section() {
		...
		$this->add_responsive_control( 'image_border_radius', [
			...
			'size_units' => [ 'px', '%' ],
			'selectors'  => [
				'{{WRAPPER}} .unicamp-image' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			],
		] );
