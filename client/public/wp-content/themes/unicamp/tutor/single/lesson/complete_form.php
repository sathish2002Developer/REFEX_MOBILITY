...
if ( ! $is_completed_lesson ) {
	...
	<div class="tutor-single-lesson-segment tutor-lesson-compelte-form-wrap">
		<form method="post">
			...
			<button type="submit" class="course-complete-button tutor-button" name="complete_lesson_btn"
			        value="complete_lesson"><i
					class="far fa-check"></i><?php esc_html_e( 'Complete Lesson', 'unicamp' ); ?>
			</button>
		</form>
	</div>
	<?php
